...
<style scoped>
.overlay {
  position: fixed; inset: 0; background: rgba(28,33,30,.4);
  backdrop-filter: blur(2px); display: grid; place-items: center; z-index: 150; padding: 24px;
}
.modal { width: 480px; max-width: 100%; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; }
