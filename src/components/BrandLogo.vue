...
<template>
  <span class="brand-logo" :class="tone">
    <svg class="mark" :width="size" :height="size" viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      <path d="M9 21 L20 10.5 L31 21" fill="none" stroke="#0E2A2A" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M12.5 19.5 V30 H27.5 V19.5" fill="none" stroke="#0E2A2A" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" opacity="0.5" />
      <circle cx="20" cy="24.5" r="2.5" fill="#0E2A2A" />
    </svg>
